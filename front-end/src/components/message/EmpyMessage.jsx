...
export default function EmpyMessage() {
  return (
    <div className="flex flex-col justify-center items-center gap-3">
      ...
      <div>
        <p className="text-center">Your Message</p>
        <p className="text-[#927373] text-sm text-center">
          Send photos and private messages to friends or groups
        </p>
      </div>
      <button className="bg-[#0095F6] text-white font-semibold py-1 px-3 rounded-lg text-sm outline-none">
        Send message
      </button>
    </div>
  );
